## This programe is used to process the json data to sql database
## The json data is generated by the ReadDBAndGenerateProtocol.py
## The sql database is used to store the data
